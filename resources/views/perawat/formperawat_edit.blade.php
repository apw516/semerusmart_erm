                    ...
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input ml-2 mr-3" type="radio" name="Riwayatpsikologi" id="Riwayatpsikologi" value="Tidak Ada" @if( $hasil[0]->Riwayatpsikologi == 'Tidak Ada' ) checked @endif>
                                    ...
                                    <div>
                                        <textarea type="text" name="keterangan_rp" id="keterangan_rp" class="form-control mt-2" placeholder="keterangan...">{{ $hasil[0]->keterangan_riwayat_psikolog }}</textarea>
                                    </div>
                                </td>
                            </tr>
                            <TR>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input ml-2 mr-3" type="radio" name="penggunaanalatbantu" id="penggunaanalatbantu" value="Lainnya" @if( $hasil[0]->penggunaanalatbantu == 'Lainnya' ) checked @endif>
                                        <label class="form-check-label" for="inlineRadio1">Lain - lain</label>
                                    </div>
                                    <div>
                                        <textarea type="text" name="keterangan_ab" id="keterangan_ab" class="form-control mt-2" placeholder="keterangan...">{{ $hasil[0]->keterangan_alat_bantu }}</textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
