...
<div style="align-items: left; padding-top: 40px;">
    ...
    <button class="btn btn-danger mt-2 hapusgambar" gambar="telingakanan">Hapus</button>
    <button class="btn btn-info mt-2" onclick="reloadgbr()">Batal</button>
    <img id="gambarnya" width="20%" src="{{ $gbr[0]->telingakanan }}" onclick="showMarkerArea(this);" />
    @else
