...
<div style="align-items: left; padding-top: 40px;">
    ...
    <button class="btn btn-danger mt-2 hapusgambar" gambar="laring" onclick="hapustanda()">Hapus</button>
    <button class="btn btn-info mt-2" onclick="reloadgbr()">Batal</button>

    <img id="gambarnya" width="20%"   src="{{ $gbr[0]->laring }}" onclick="showMarkerArea(this);" />
    @else
    <img id="gambarnya" width="340px"   src="{{ asset('public/img/laring.png') }}" onclick="showMarkerArea(this);" />
